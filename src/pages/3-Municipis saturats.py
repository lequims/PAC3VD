...
# Títol
st.title("Saturació turśitica per municipis de Mallorca")


'''
Per a calcula un índex de saturació turística per municipi, hem tingut en compte la relació entre la població resident i el nombre de places totals ofertades. Aquest índex ens permetrà identificar els municipis més saturats i, per tant, on la pressió turística és més elevada.
